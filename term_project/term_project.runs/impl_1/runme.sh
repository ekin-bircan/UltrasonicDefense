...
HD_PWD='E:/BILKENT/Bilkent 3.1/EEE102/Term Project/term_project/term_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_topm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_topm.tcl -notrace
