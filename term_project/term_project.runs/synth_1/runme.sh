...
HD_PWD='E:/BILKENT/Bilkent 3.1/EEE102/Term Project/term_project/term_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_topm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_topm.tcl
